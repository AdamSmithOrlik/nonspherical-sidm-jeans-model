...
def relaxation(r1,outer_halo,Phi_b=None,max_iter=100,init_grid=5,r_grid=200,verbose=False,finaltol=1e-8,**extraneous):
    ...
    while grid_size <= r_grid:
        ...
        if verbose:
            print('  iteration %d: number of grid points = %d, was a success: %s' % (num_iter, grid_size, str(success_flag)))
